...
In Java 8 (till Java 11) there is a nice method _'ObjectSizeCalculator.getObjectSize'_ in _'jdk.nashorn.internal.ir.debug.ObjectSizeCalculator'_ package.<br>
<br>
